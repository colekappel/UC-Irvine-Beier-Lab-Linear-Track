...
amp4mo = readtable('Raw Data for 4 mo LT All Cells/AmplitudeData.csv');
er4mo = readtable('Raw Data for 4 mo LT All Cells/EventRateData.csv');
info4mo = readtable('Raw Data for 4 mo LT All Cells/InfoScoreData.csv');
sparsity4mo = readtable('Raw Data for 4 mo LT All Cells/SparsityData.csv');
stab1v24mo = readtable('Raw Data for 4 mo LT All Cells/Stability1v2Data.csv');
stabAv4mo = readtable('Raw Data for 4 mo LT All Cells/StabilityAvData.csv');
stabOE4mo = readtable('Raw Data for 4 mo LT All Cells/StabilityOE.csv');
...
amp8mo = readtable('Raw Data for 8 mo LT All Cells/AmplitudeData.csv');
er8mo = readtable('Raw Data for 8 mo LT All Cells/EventRateData.csv');
info8mo = readtable('Raw Data for 8 mo LT All Cells/InfoScoreData.csv');
sparsity8mo = readtable('Raw Data for 8 mo LT All Cells/SparsityData.csv');
stab1v28mo = readtable('Raw Data for 8 mo LT All Cells/Stability1v2Data.csv');
stabAv8mo = readtable('Raw Data for 8 mo LT All Cells/StabilityAvData.csv');
stabOE8mo = readtable('Raw Data for 8 mo LT All Cells/StabilityOE.csv');
...
saveas(gcf,'/Users/colekappel/Desktop/All Cells 4 v 8 Mo Plots/plusAmplitudeBar.svg')
...
saveas(gcf,'/Users/colekappel/Desktop/All Cells 4 v 8 Mo Plots/plusErBar.svg')

%% 5x+ info score bar plot
figure;

b = bar([1,2],[mean(info4moPlus{:,'InformationScore'}),mean(info8moPlus{:,'InformationScore'})],'FaceColor','flat');
b.CData(2,:) = [1 0 0];
hold on 

errorbar(1,mean(info4moPlus{:,'InformationScore'}),...
    std(info4moPlus{:,'InformationScore'})/sqrt(height(info4moPlus)))

errorbar(2,mean(info8moPlus{:,'InformationScore'}),...
    std(info8moPlus{:,'InformationScore'})/sqrt(height(info8moPlus)))
...
saveas(gcf,'/Users/colekappel/Desktop/All Cells 4 v 8 Mo Plots/plusInfoBar.svg')
...
saveas(gcf,'/Users/colekappel/Desktop/All Cells 4 v 8 Mo Plots/plusSparsityBar.svg')
...
saveas(gcf,'/Users/colekappel/Desktop/All Cells 4 v 8 Mo Plots/plusStab1v2Bar.svg')
...
saveas(gcf,'/Users/colekappel/Desktop/All Cells 4 v 8 Mo Plots/plusStabAvBar.svg')
...
saveas(gcf,'/Users/colekappel/Desktop/All Cells 4 v 8 Mo Plots/plusStabOEBar.svg')
...
saveas(gcf,'/Users/colekappel/Desktop/All Cells 4 v 8 Mo Plots/minusAmplitudeBar.svg')
...
saveas(gcf,'/Users/colekappel/Desktop/All Cells 4 v 8 Mo Plots/minusErBar.svg')

%% 5x- info score bar plot
figure;

b = bar([1,2],[mean(info4moMinus{:,'InformationScore'}),mean(info8moMinus{:,'InformationScore'})],'FaceColor','flat');
b.CData(2,:) = [1 0 0];
hold on 

errorbar(1,mean(info4moMinus{:,'InformationScore'}),...
    std(info4moMinus{:,'InformationScore'})/sqrt(height(info4moMinus)))

errorbar(2,mean(info8moMinus{:,'InformationScore'}),...
    std(info8moMinus{:,'InformationScore'})/sqrt(height(info8moMinus)))
...
saveas(gcf,'/Users/colekappel/Desktop/All Cells 4 v 8 Mo Plots/minusInfoBar.svg')
...
saveas(gcf,'/Users/colekappel/Desktop/All Cells 4 v 8 Mo Plots/minusSparsityBar.svg')
...
saveas(gcf,'/Users/colekappel/Desktop/All Cells 4 v 8 Mo Plots/minusStab1v2Bar.svg')
...
legend('4 month','std 4 mo', 'std 8 mo')
hold off
saveas(gcf,'/Users/colekappel/Desktop/All Cells 4 v 8 Mo Plots/minusStabAvBar.svg')
...
saveas(gcf,'/Users/colekappel/Desktop/All Cells 4 v 8 Mo Plots/minusStabOEBar.svg')

% lme formulas
lmeFormulaAmp = 'avAmplitudeForEachCell~age+(1|MouseID)';
lmeFormulaER = 'eventRatePerCell~age+(1|MouseID)';
lmeFormulaInfo = 'InformationScore~age+(1|MouseID)';
